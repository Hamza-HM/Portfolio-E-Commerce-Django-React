...
urlpatterns = [
    ...
    path('profiles/<int:pk>/', views.UserControleViewSet.as_view({'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy'}), name='profiles-controle'),
    path('profile/<int:pk>', views.UserProfileViewSet.as_view({'get': 'retrieve', 'put': 'update', 'patch': 'partial_update'}), name='profile-detail'),
